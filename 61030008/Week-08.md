...
ไม่สามารถรันโปรเเกรมได้เนื่องจากไม่มีการประกาศสมาชิกในอาร์เรย์ ต้องประกาศสมาชิกในอาร์เรย์
...
![](./pic/แบบฝึกการค้นหาสมาชิกในอาร์เรย์1.1.JPG)
![](./pic/แบบฝึกการค้นหาสมาชิกในอาร์เรย์1.2.JPG)
...
![](./pic/แบบฝึกการค้นหาสมาชิกในอาร์เรย์2.1.JPG)
...
![](./pic/แบบฝึกการเรียงข้อมูลในอาร์เรย์1.JPG)
![](./pic/แบบฝึกการเรียงข้อมูลในอาร์เรย์1.2.JPG)
...
![](./pic/แบบฝึกการเรียงข้อมูลในอาร์เรย์2.JPG)
![](./pic/แบบฝึกการเรียงข้อมูลในอาร์เรย์2.2.JPG)
...
![](./pic/3.1.1.1.JPG)
![](./pic/3.1.1Error.JPG)
จะเกิด Error ถ้าใช้ Arrylist
List จะเห็นจากกระบวนการทำให้เกิด Polymorphism คือเราต้องการแค่ Object ที่เป็น List โดยไม่สนใจว่าจะเป็น List แบบใหน ขอแค่ให้เก็บข้อมูลเป็น List ได้ก็พอ
ถ้าArrayList เราต้องการระบุเจาะจงเพื่อใช้ประโยชน์จาก Class ArrayList

### คำถาม

1. เมื่อความจำนวนสมาชิกในอาร์เรย์ลิสต์ (Count) เพิ่มขึ้นถึงค่าเท่าใดบ้างจึงจะมีการเพิ่มค่าความจุ (Capacity)

ตอบ เมื่อความจำนวนสมาชิกในอาร์เรย์ลิสต์ (Count) เพิ่มขึ้นถึงค่าเท่ากับ 4,8,16,32 และ64 จึงจะมีการเพิ่มค่าความจุ 

2. การเพิ่มค่าความจุในอาร์เรย์ลิสต์มีลักษณะเป็นอย่างไร

ตอบ การเพิ่มค่าความจุในอาร์เรย์ลิสต์จะเพิ่มเมื่อความจำนวนสมาชิกในอาร์เรย์ลิสต์ (Count) เพิ่มขึ้นถึงค่าเท่ากับ 4,8,16,32 และ64 
โดยเริ่มจาก 2^n เรื่มตั้งเเต่ n=2
...
RemoveAt(int)เป็นการนำข้อมูลออกจากArray ผลลัพธ์ของการลบก็คือ Index

Remove(object) เป็นการนำข้อมูลออกจากArray ผลลัพธ์ของการลบก็คือ Index ภายในArrayหลังจากตำแหน่งที่ถูกลบจะเลื่อนลงมาหนึ่ง
...
clear() ใช้สำหรับลบข้อมูลทั้งหมดออกจากArray และ

CopyTo() นำข้อมูลจาก object มาคลายแล้วนำไปเก็บไว้

indexOf() ใช้รับค่าของ Index ของข้อมูลที่ต้องการในArray
