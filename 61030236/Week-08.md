...
![](images/1.PNG)
เกิด error เพราะว่าการประกาศตัวแปรของอาเรย์ในการเก็บข้อมูลแค่ 0-9 เท่านั้น แต่ค่าที่ให้มามีการเกินกว่าที่กำหนด
การรันเลยเกิดข้อผิดพลาด
...
![](images/2.PNG)
เกิด error เพราะว่าค่าที่ให้เก็บข้อมูลของอาเรย์นั้น มีไม่ครบตามที่เราระบุการเก็บข้อมูลโปรแกรมจึงเกิดการรันผิดพลาด
...
![](images/3.PNG)
เป็นการ retuen ค่ากลับจากการเรียกใช้ Class Student 
...
เป็นการเพิ่มตามเท่าที่เราอยากจะเพิ่มเข้าไปเพื่อเก็บข้อมูลที่เราต้องการ
...
ArrayList แต่ละตัวที่เราเขียนมามีข้อมูลของArrayListที่ไม่เท่ากัน ซึ่งความจุของแต่ละArrayไม่เท่ากันนั่นเอง
...
ได้ เพราะเราสามารถกำหนดให้คำนวณได้นั่นเอง
