...
![](images/1.PNG)
 ...
 ##  การแก้ไข
``` text 
เนื่องจากเราประกาศค่าอาเรย์ให้มีขนาด 10 แต่มีการประกาศแสดงผลเกินมาหนึ่งจึงทำให้เกิด error แก้ไข
โดยการลบบรรทัด data[10] = 10; และ Console.WriteLine(data[10]); จึงจะแสดงผลได้ไม่มีปัญหา
```
![](images/1.1.PNG)
...
2.สร้างอาร์เรย์เก็บคะแนน gpa ของนักศึกษาในห้อง
จeนวนสูงสุด 45 คน โดยใช้ตัวแปรชื่อ stuGPA, มี
ชนิดข้อมูลเป็น float
```csharp

  float[] stuGPA = new stuGPA[45];

```

3.สร้างอาร์เรย์เก็บชื่อจังหวัดในประเทศไทย โดยไม่
ต้องคำนึงถึงภาคหรือลeดับตัวอักษรใดๆ
```csharp
int [] vil = new int [77];
```
...
![](images/2.PNG)
```text
การเข้าถึงข้อมูลในอาเรย์ห้ามติดลบแต่ให้เริ่มจาก 0 แทนและห้ามประกาศข้อมูลเกินขนาดที่ก าหนดไว้แก้ไข
โดยลบบรรทัด data[10] = 10; และ Console.WriteLine(data[10]);
```
### การแก้ไข
![](images/2.11.PNG)
...
โปรแกรมรันได้ปกติให้ผลถูกต้องไม่เกิด error
...
บันทึกผลการทดลองโปรแกรมรันได้ปกติไม่เกิด error
โปรแกรมนี้บอกขนาดอาเรย์และบอกว่าข้อมูลในอาเรย์มีอะไรบ้าง
```
...
➢ รันโปรแกรมและบันทึกผล ถ้ามีปัญหา แก้ไขอย่างไร อธิบายว่าเหตุใดจึงเป็นเช่นนั้น
 ...
 ![](images/2.2.PNG)
 ```csharp
จะเห็นว่าการแสดงผลหายไป 1 บรรทัดเพราะจากเงื่อนไขการค้นหาข้อมูล fish ไม่มีอยู่ใน array1 จึงข้ามไป
ทำงานต่อไป
```
### แบบฝึกหัด
...
![](images/66.PNG)
2. สร้างอาร์เรย์ ที่เก็บประเทศต่างๆในโลกภาษาอังกฤษ)  
a. เรียงลำดับชื่อตามตัวอักษรจากน้อยไปมาก  
![](images/แบบน.PNG)
b. เรียงลำดับชื่อตามตัวอักษรจากมากไปน้อย 
![](images/แบบ2.2.PNG)
...
2.สร้างอาร์เรย์สองมิติ ชื่อ character โดยมี 2
คอลัมน์ ส าหรับเก็บตัวอักษรตัวพิมพ์ใหญ่และพิมพ์
เล็กในภาษาอังกฤษ

```csharp
char[,] character = new char[26,2];
```

3.สร้างอาร์เรย์สองมิติ ชื่อ monthday โดยมี 2
คอลัมน์
- คอลัมน์ที่ 1 เก็บจ านวนวันในแต่ละเดือน
- คอลัมน์ที่ 2 เก็บเลขวันของวันที่ 1 เช่น วันที่ 1
ตรงกับวันอาทิตย์ใช้เลข 0 เป็นต้น
...
4 สร้างอาร์เรย์สามมิติ ชื่อ cube ขนาด 3 x 3 x 3
...
```csharp
   เพิ่มค่าตามจำนวนสมาชิกถ้า มีสมาชิก 4 ตัวก็ 4 บิต 8 ตัวก็ 8 บิต
```

2. การเพิ่มค่าความจุในอาร์เรย์ลิสต์มีลักษณะเป็นอย่างไร

```csharp
เพิ่มตามจำนวนสมาชิกเรื่อยๆ
```
...
```text
ค่า count คือการนับจำนวนสมาชิกด้านในส่วน capacity คือขนาดความจุที่ใช้เก็บสมาชิกเป็นบิต
```
...
```text
การลดจำนวนสมาชิกอาจทำให้ capacity ลดลง เช่น หากมีสมาชิก 4 ตัวจะทำให้ความจุเหลือ 4 บิต หรือถ้าเพิ่ม
เป็น 5,6,7,8 ก็จะมีความจุเป็น 8 บิต นั่นคือค่าความจุจะลดจะเพิ่มตามความเหมาะสมของสมาชิกที่มีอยู่ในอาเรย์
...
![](images/3.1.3.PNG)
``` text
โปรแกรมเกิด error เพราะมีการบอกค่าตำแหน่งในอาเรย์เกินกว่าที่กำหนดไว้ใน list2 แก้ไขได้โดย
เปลี่ยนตัวเลขตำแหน่งอาเรย์ให้มีค่าอยู่ในขอบเขตที่กำหนดไว
```
## ที่แก้แล้ว
![](images/3.1.3.1.PNG)
## คำถาม
...
```
ได้ เพราะ การเข้าถึงข้อมูลอาเรย์ลิสต์มีลักษณะคล้ายกับอาเรย์ธรรมดาต่างตรงที่อาเรย์ลิสต์ไม่จำเป็นต้องบอกชนิด
ข้อมูลแล้วกำหนดขนาดความจ
```
...
* `RemoveAt(int)`  ##   [สามารถระบุตำแหน่งที่จะลบในอาเรย์ลิสตได้]

![](images/งค1.PNG)
* `Remove(object)` [สามารถระบุตำแหน่งที่จะลบในอาเรยล์ิสตได้เป็นวัตถุ]

![](images/งค2.PNG)
* `Insert(int, object)`[แทรกข้อมูลใดๆลงในค่าที่ระบุ]
...
* `CopyTo()`[คัดลอกข้อมูลจากคิวไปยังอาเรย์]

![](images/งค5.PNG)
* `IndexOf()`[ค้นหาข้อมูลที่ถูกระบุแล้วส่งค่าIndexกลับมา]
![](images/งค6.PNG)
...
![](images/3.2.3.1.PNG)
``` text
โปรแกรมerrorไม่สามารถรันได้
 
```
##เมื่อแก้ไขแล้ว
![](images/3.2.3.1.2.PNG)
...
![](images/3.4.2.PNG)
``` text
โปรแกรมรันได้ถูกต้องไม่เกิด error
ที่ได้ผล 1 เพราะไม่มีค่า Eleven ในสมาชิกดิกชันนาร
```
